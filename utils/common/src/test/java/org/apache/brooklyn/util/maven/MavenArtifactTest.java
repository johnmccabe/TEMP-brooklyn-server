...
public class MavenArtifactTest {
    ...
    final static String THIS_PROJECT_COORDINATE = "org.apache.brooklyn:brooklyn-utils-common:jar:0.9.1-SNAPSHOT";  // BROOKLYN_VERSION
    ...
    /*
        ...
        Message: Could not load /home/ubuntu/.m2/repository/org/apache/brooklyn/brooklyn-utils-common/0.9.1-SNAPSHOT/brooklyn-utils-common-0.9.1-SNAPSHOT.jar when testing MavenRetriever: do a maven build with no integration tests first to ensure this is installed, then rerun
        Stacktrace:
    ...
    public void testRetrievalHostedSnapshotIntegration() throws Exception {
        MavenArtifact m = MavenArtifact.fromCoordinate(
                "org.apache.brooklyn:brooklyn-utils-common:jar:0.9.1-SNAPSHOT");  // BROOKLYN_VERSION
